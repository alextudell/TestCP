    ...
    public sealed class PromoService : IPromoService
    {
        ...
        public PromoService()
        {
            var data = new List<PromoData>()
            {
                ...
                new ("Сommon \ninapp", PromoType.Special, PromoRarity.Common, 15),
                new ("Сommon \ninapp", PromoType.Special, PromoRarity.Common, 25),
                new ("Rare \ninapp", PromoType.Special, PromoRarity.Rare, 65),
                new ("Common \nspec", PromoType.Crystal, PromoRarity.Common, 25),
                new ("Rare \nspec", PromoType.Crystal, PromoRarity.Rare, 100),
                new ("Common \nspec", PromoType.Crystal, PromoRarity.Common, 35),
                new ("Epic \nspec", PromoType.Crystal, PromoRarity.Epic, 40)
            };
